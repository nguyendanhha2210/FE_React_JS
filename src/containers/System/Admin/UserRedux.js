...
class UserRedux extends Component {
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrCheck = ["email", "password", "firstName", "lastName", "phoneNumber", "address", "gender", "position", "role", "avatar"]
    ...
    render() {
        ...
        let language = this.props.roleRedux;
                ...
                <div className="user-redux-body">
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-12 my-3'><button type="submit" className={this.state.action === CRUD_ACTIONS.EDIT ? "btn btn-warning" : "btn btn-primary"} onClick={() => this.handleSaveUser()}>
